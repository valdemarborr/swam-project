...
public class Main {
    public static void main(String[] args) {
        ...
        shoppingCartItemDAO.entityManager = em;
        ...
        for (int run = 0; run < fetchRuns; run++) {
            ...
            for (User user : allUsers) {
                ...
                List<ShoppingCartItem> cartItems = shoppingCartItemDAO.findByUserId(user.getId());
                ...
                List<StoreOrder> orders = storeOrderDAO.findByUserId(user.getId());
